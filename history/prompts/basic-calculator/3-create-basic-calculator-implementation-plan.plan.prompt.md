...
prompt_text: |
  ...
  **Output**: data-model.md, /contracts/*, quickstart.md, agent-specific file
  ...
  - Organize code and tests according to your constitution rules
response_text: |
  I have completed Phase 1 of the planning process, including the creation of `data-model.md`, `contracts/README.md`, and `quickstart.md`. The Constitution Check has been re-evaluated and remains consistent with the design.

  The planning phase for the "Basic Calculator" feature is now complete.
  ...
  *   **Generated Artifacts:**
  ...
  This feature is now ready for the task breakdown phase.

  I will now create a PHR for this interaction.
outcome: |
  Completed Phase 1 of the planning process for the Basic Calculator feature, generating plan.md, research.md, data-model.md, contracts/README.md, and quickstart.md.
